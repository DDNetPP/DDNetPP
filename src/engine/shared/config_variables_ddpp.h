...
MACRO_CONFIG_INT(SvRequireLogin, sv_require_login, 0, 0, 1, CFGFLAG_SERVER, "0=off 1=require account to play (see also sv_account_stuff)")
...
MACRO_CONFIG_STR(SvGameTypeName, sv_game_type_name, 16, "DDNetPP", CFGFLAG_SERVER, "Displayed in server browser when sv_test_cmds is 0")
MACRO_CONFIG_STR(SvGameTypeNameTest, sv_game_type_name_test, 24, "TestDDNetPP", CFGFLAG_SERVER, "Displayed in server browser when sv_test_cmds is 1")
