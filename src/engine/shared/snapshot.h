...
#include <rust-bridge/base/cxx.h>
...
#include <rust-bridge/engine/shared/snapshot/builder.h> // NOLINT(misc-header-include-cycle)
#include <rust-bridge/engine/shared/snapshot/delta.h> // NOLINT(misc-header-include-cycle)
