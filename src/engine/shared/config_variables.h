...
MACRO_CONFIG_INT(SvAllowMinigame, sv_allow_minigame, 1, 0, 3, CFGFLAG_SERVER, "allow users to play minigames")
...
MACRO_CONFIG_INT(SvDDPPgametype, sv_ddpp_gametype, 0, 0, 1, CFGFLAG_SERVER, "0=ddpp 1=fly")
