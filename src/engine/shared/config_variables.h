...
MACRO_CONFIG_INT(SvDDRaceRules, sv_ddrace_rules, 0, 0, 1, CFGFLAG_SERVER, "Whether the default mod rules are displayed or not") //rules are for pussys heueueu this is ddpp
...
MACRO_CONFIG_INT(SvAllowDroppingWeapons, sv_allow_dropping_weapons, 2, 0, 4, CFGFLAG_SERVER, "0=off, 1=all (+spawnweaps), 2=normal weaps+hammer+gun, 3=normal weaps+spawnweaps, 4=normal weaps")
...
MACRO_CONFIG_INT(SvDDPPgametype, sv_ddpp_gametype, 0, 0, 5, CFGFLAG_SERVER, "0=ddpp 1=fly 2=survival(force) 3=survival(leavable) 4=vanilla 5=fng")
