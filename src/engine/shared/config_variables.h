...
MACRO_CONFIG_INT(SvVoteYesPercentage, sv_vote_yes_percentage, 100, 1, 100, CFGFLAG_SERVER, "The percent of people that need to agree or deny for the vote to succeed/fail")
