...
CHAT_COMMAND("insta", "?s", CFGFLAG_CHAT | CFGFLAG_SERVER, ConInsta, this, "play instagib games like gdm or idm")
...
CHAT_COMMAND("tcmd3000", "?ii", CFGFLAG_CHAT | CFGFLAG_SERVER, ConTCMD3000, this, "secret test command dont use")
