...
void CCharacter::HandleWeapons()
{
	...
	// ddnet++
	GameServer()->m_pController->PostCharacterHandleWeapons(this);
}
...
void CCharacter::SnapCharacter(int SnappingClient, int Id)
{
	...
	if(!Server()->IsSixup(SnappingClient))
	{
		...
		// ddnet++
		if(Character.m_HookedPlayer == CLIENT_ID_FLAG_RED || Character.m_HookedPlayer == CLIENT_ID_FLAG_BLUE)
		{
			...
			Character.m_HookedPlayer = 60; // TODO: find a good value for that matching the FakeSnap
			Character.m_HookedPlayer = -1;
		}
		else if(Character.m_HookedPlayer != -1)
		{
		...
		// ddnet++
		GameServer()->m_pController->SnapCharacter6(SnappingClient, this, &Character);
...
void CCharacter::Snap(int SnappingClient)
{
	...
	// ddnet++
	GameServer()->m_pController->SnapDDNetCharacter(SnappingClient, this, &DDNetCharacter);
