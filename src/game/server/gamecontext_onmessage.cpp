...
bool CGameContext::AbortKill(int ClientID, CPlayer *pPlayer, CCharacter *pChr)
{
	...
	if(m_apPlayers[ClientID]->m_IsBlockTourning && (m_pBlockTournament->m_State == CBlockTournament::STATE_IN_GAME || m_pBlockTournament->m_State == CBlockTournament::STATE_COOLDOWN))
	{
