...
CONSOLE_COMMAND("Rainbow", "v", CFGFLAG_SERVER, ConRainbow, this, "activates rainbow until death")
...
CONSOLE_COMMAND("dummymode", "vi", CFGFLAG_SERVER, Condummymode, this, "0 default 1 move 2 move harder 3 random")
...
CONSOLE_COMMAND("Bloody", "v", CFGFLAG_SERVER, ConBloody, this, "activates bloody until death")
