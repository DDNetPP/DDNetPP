...
CONSOLE_COMMAND("jetpack", "v[id]", CFGFLAG_SERVER | CMDFLAG_TEST, ConJetpack, this, "Gives jetpack to you")
CONSOLE_COMMAND("weapons", "", CFGFLAG_CHAT | CFGFLAG_SERVER | CMDFLAG_TEST, ConWeapons, this, "Gives all weapons to you")
...
CONSOLE_COMMAND("unsuper", "v[id]", CFGFLAG_SERVER, ConUnSuper, this, "Removes super from you")
...
CONSOLE_COMMAND("livefreeze", "v[id]", CFGFLAG_SERVER | CMDFLAG_TEST, ConLiveFreeze, this, "Makes you live frozen")
CONSOLE_COMMAND("unlivefreeze", "v[id]", CFGFLAG_SERVER | CMDFLAG_TEST, ConUnLiveFreeze, this, "Puts you out of live freeze")
