...
#define cprintf if(0)printf
#define cputchar if(0)putchar
...
int main(int argc, const char **argv)
{
	...
	for(int i = 0; i < DataFile.NumData() || i == SettingsIndex; i++)
	{
